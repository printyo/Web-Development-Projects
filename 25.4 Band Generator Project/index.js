...
app.post("/submit", (req, res) => {
    ...
    const rand1 = Math.floor(Math.random() * adj.length);
    const rand2 = Math.floor(Math.random() * noun.length);
    const nameGen = adj[rand1] + " " + noun[rand2];
    res.render("index.ejs", { name: nameGen });
});
